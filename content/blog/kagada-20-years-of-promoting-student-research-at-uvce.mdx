...
tags: ["kagada", "research", "ieee", "sampada"]
---

<Callout type="info" title="Event Spotlight">
  **By Team MyUVCE | December 2025** Exploring the two-decade journey of Kagada and how it became the premier cradle of undergraduate research at UVCE.
</Callout>
...
<Testimonial 
  quote="Kagada stands as a distinguished platform where students present their posters, projects, and papers, gaining exposure to research and professional dialogue."
  author="Dr. A V Sriram"
  role="Registrar, UVCE"
/>
...
By **2008**, Kagada had matured into the "Fifth National Student Conference." It wasn't just about reading a paper anymore; it was about rigorous academic inquiry. The 2009 edition and the 2010 edition saw participation numbers swell. In 2010 alone, over 100 students participated, with more than 35 technical papers presented—a significant number for a student-run event at the time.
...
| :--- | :--- |
| **2013** | Witnessed participation from colleges across Mysore, Mandya, Mangalore, and Belgaum, cementing its national status. |
| **2014** | Expanded to include community outreach. A full-day event for BBMP High School students was organized via TISP. |
| **2016** | The TISP & STAR workshop for government school students became a staple, blending research with social responsibility. |

## The Modern Era: Kagathon and Hybrid Innovations (2017–2025)

To keep pace with the software boom and the "maker" culture, Kagada had to reinvent itself again. The 2017-18 session saw the introduction of **Kagathon**, a pre-Kagada hackathon. This event was designed to get students' hands dirty with code and hardware before the main conference. It complemented the "Project Run," a 3-month long contest where teams built innovative prototypes in IoT, Machine Learning, and App Development.

Even the global pandemic couldn't dampen the spirit of Kagada. The 2020 and 2021 editions seamlessly transitioned to virtual and hybrid modes. 

### KAGADA 2025: The 21st Edition

Fast forward to November 2025. The 21st Annual National-Level Technical Student Conference was held on November 8th, and it was a spectacle of modern engineering, seeing a staggering 537 participants.
...
* **Poster Presentation Track:** A hybrid mode expanded to include Cybersecurity alongside Core and IT domains.

Notably, the event was supported by the *MARVEL R&D Lab*. MARVEL students presented cutting-edge work, such as "Path Planning for AUV using Hybrid DQN" and "AquaSpectra"—an autonomous microplastic detection system. These aren't just college projects; they are viable solutions to real-world problems.

<Callout type="success" title="The Core Vision">
...
<div className="flex justify-center mt-10 mb-6">
  <a 
    ...
    className="inline-flex items-center gap-2 px-8 py-3 border-2 border-neutral-900 dark:border-white text-neutral-900 dark:text-white font-bold rounded-xl hover:bg-neutral-100 dark:hover:bg-neutral-900 transition-colors"
  >
    Visit MyUVCE.in for more updates
  </a>
</div>