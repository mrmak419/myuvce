...
<Callout type="info" title="The Criteria">
...
<MetricCardGroup>
  <MetricCard title="Distance" value="~55 km" description="From K.R. Circle via Magadi Road" />
  <MetricCard title="Difficulty" value="Moderate" description="Watch out for road widening works" />
</MetricCardGroup>
...
<Callout type="tip" title="Student Tip">
...
<MetricCardGroup>
  <MetricCard title="Distance" value="~40 km" description="Bannerghatta/Kanakapura belt" />
  <MetricCard title="Difficulty" value="High" description="Last 2 km is pure off-road" />
</MetricCardGroup>
...
<MetricCardGroup>
  <MetricCard title="Distance" value="~40 km" description="Near Savandurga" />
  <MetricCard title="Difficulty" value="Moderate" description="Slushy/Sandy tracks available" />
</MetricCardGroup>
...
<MetricCardGroup>
  <MetricCard title="Distance" value="~70 km" description="Towards Kolar via Old Madras Road" />
  <MetricCard title="Difficulty" value="Easy / Curvy" description="Highway + Hill Climb" />
</MetricCardGroup>
...
<Callout type="tip" title="Best Time">
...
<MetricCardGroup>
  <MetricCard title="Distance" value="~90 km" description="Hyderabad Highway" />
  <MetricCard title="Difficulty" value="Long" description="Highway + Village Roads" />
</MetricCardGroup>
...
<Callout type="success" title="Student Budget Check">
...
| Feature | Savandurga | Manchanabele | Muninagara | Anthargange | Gudibande |
| :--- | :--- | :--- | :--- | :--- | :--- |
| **Best Vehicle** | Bike/Car | Bike (Off-road) | Bike (ADV) | Bike/Car | Car/Bike |
| **Drive Time** | 1.5 - 2 Hrs | 1.5 Hrs | 1.5 Hrs | 2 Hrs | 2.5 Hrs |
| **Crowd** | Medium | Low | Very Low | Medium | Low |
| **Entry Fee** | Free + Parking | Free | Free | Free | Free |

<br/>

<Tabs>
  <Tab label="🚗 Vehicle Tips">
