...
author: "GOURAV P D"
tags: ["alumni", "drdo", "defense", "sampada"]
---

<Callout type="tip" title="Sampada 30 Days Series | Day 10">
  Exploring the evolution of India's strategic independence through the lens of a UVCE graduate who dedicated his life to the philosophy of "Atmanirbhar Bharat".
</Callout>
...
<Testimonial 
  quote="Self-reliance in defense is not a luxury, it is a necessity for a sovereign nation. UVCE taught us that engineering is the art of solving problems for society."
  author="Dr. V.K. Aatre"
  role="Reflections on Innovation"
/>
...
<FeatureGrid>
  <FeatureCard 
    title="1961: The Foundation" 
    description="Graduated from UVCE with a degree in Electrical Engineering."
    iconName="GraduationCap"
  />
  <FeatureCard 
    title="1967: Global Academia" 
    description="Awarded Ph.D. in Electrical Engineering from the University of Waterloo, Canada."
    iconName="Globe"
  />
  <FeatureCard 
    title="1980: Return to India" 
    description="Joined DRDO at the Naval Physical & Oceanographic Laboratory (NPOL), revolutionizing sonar tech."
    iconName="Ship"
  />
  <FeatureCard 
    title="2000: Scientific Advisor" 
    description="Appointed Scientific Advisor to the Defence Minister, succeeding Dr. APJ Abdul Kalam."
    iconName="Shield"
  />
  <FeatureCard 
    title="2016: Highest Honors" 
    description="Conferred the Padma Vibhushan by the Government of India for exceptional national service."
    iconName="Award"
  />
</FeatureGrid>
