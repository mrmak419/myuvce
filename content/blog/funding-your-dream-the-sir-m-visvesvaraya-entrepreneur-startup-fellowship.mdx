...
author: "Shreyas V"
tags: ["startup", "fellowship", "entrepreneurship", "sampada"]
---

<Callout type="tip" title="Sampada 30 Days Series">
  **Funding Your Dream: The Sir M. Visvesvaraya Entrepreneur & Startup Fellowship** A deep dive into how UVCE is structuring support for student founders to take their ideas beyond the classroom.
</Callout>
...
<Callout type="warning" title="Core Philosophy">
  This fellowship treats entrepreneurship as an extension of engineering education—where learning happens through building, testing, failing, and iterating.
</Callout>
...
<FeatureGrid>
  <FeatureCard 
    ...
    description="Currently enrolled UVCE students across all programs and years are encouraged to apply."
    iconName="GraduationCap"
  />
  <FeatureCard 
    title="Recent Alumni" 
    description="Recent UVCE alumni who are committed full-time to building their venture."
    iconName="Briefcase"
  />
  <FeatureCard 
    title="Early Stage Teams" 
    description="Teams currently at the idea, prototype, or early-revenue stages are eligible."
    iconName="Lightbulb"
  />
  <FeatureCard 
    title="Impact Driven" 
    description="Startups aligned with technology, sustainability, or broader societal impact."
    iconName="Globe"
  />
</FeatureGrid>
