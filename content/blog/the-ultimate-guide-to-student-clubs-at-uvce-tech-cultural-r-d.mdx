...
<Callout type="tip" title="Student Autonomy">
...
* **Links:** [Instagram](https://www.instagram.com/ieeeuvce) | [Website](https://ieeeuvce.in)
...
* **Links:** [Website](https://gdg.community.dev/gdg-on-campus-university-visvesvaraya-college-of-engineering-bangalore-india/)
...
* **Links:** [Instagram](https://www.instagram.com/marvel_uvce/) | [Website](https://hub.uvcemarvel.in/)
...
* **Links:** [Instagram](https://www.instagram.com/uvce_adhamya/)
...
* **Links:** [Instagram](https://www.instagram.com/uvce_tatva/)
...
* **Links:** [Instagram](https://www.instagram.com/ecelluvce)
...
<FeatureGrid>
  <FeatureCard 
    ...
    description="Companies want freshers with experience, but how do you get experience without a job? Organizing a fest like Impetus or building a car with SAE gives you verifiable management and engineering experience."
    iconName="Briefcase"
  />
  <FeatureCard 
    title="The Alumni Network" 
    description="Most active alumni were once part of these clubs. Being in IEEE or SAE connects you directly with seniors working in top companies like Apple, Tesla, and Microsoft."
    iconName="Network"
  />
  <FeatureCard 
    title="Vital Soft Skills" 
    description="You cannot learn leadership in a classroom. You learn it when you have to manage a budget of ₹5 Lakhs for a fest or convince a corporate sponsor to fund your event."
...
<AccordionGroup>
  <Accordion title="Can I join multiple clubs?">
    Yes! Many students are in IEEE (Technical) and Adhamya (Cultural). However, be careful not to burn out. Pick 1 or 2 clubs where you can genuinely contribute and make an impact.
  </Accordion>
  <Accordion title="Are these clubs only for specific branches?">
    No. While SAE is Mechanical-heavy and GDSC is CS-heavy, they are strictly open to ALL branches. A Mechanical student can learn coding in GDSC, and a CS student can manage logistics for SAE.
  </Accordion>
  <Accordion title="Do club activities affect attendance?">
    UVCE is generally flexible, but you need to balance it. Do not skip mandatory labs for club meetings. Fortunately, most club activities happen after college hours (4:30 PM onwards) or on weekends.
  </Accordion>
  <Accordion title="Is there a fee to join?">
    Some international bodies like IEEE or SAE require a global membership fee (approx ₹1500-₹2000/year), which gives you an official ID and access to global resources. College-level clubs like Adhamya or MARVEL are usually free or have minimal costs.
  </Accordion>
</AccordionGroup>
...
<div className="pt-6 mt-8 border-t border-neutral-200 dark:border-neutral-800 text-sm text-neutral-500 dark:text-neutral-400 text-center">
  **New to campus?** Find the MARVEL lab or the Placement Office using our **[Campus Map](https://myuvce.in/2025/11/the-map-of-uvce.html)**.
</div>